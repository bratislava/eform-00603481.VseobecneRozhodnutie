...
<xsl:stylesheet xml:lang="en" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  xmlns:xi="http://www.w3.org/2001/XInclude" xmlns:exsl="http://exslt.org/common"
    ...
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
      ...
      <fo:page-sequence master-reference="document" font-family="Arial">
        ...
        <fo:flow flow-name="xsl-region-body">
          <fo:block font-size='20pt' text-align='center'>Všeobecné rozhodnutie</fo:block>
  ...
  <xsl:template match="egonp:GeneralAgenda">
    <fo:block start-indent='5mm'>
      <fo:block background-color='black' color='white'>Všeobecné rozhodnutie</fo:block>
      <fo:block color='white'>|</fo:block>
      ...
      <fo:table space-before='2mm'>
        ...
        <fo:table-body>
          <fo:table-row>
            ...
            <fo:table-cell height='100px' border-width='0.6pt' border-style='solid'
              background-color='white' padding='1pt'>
